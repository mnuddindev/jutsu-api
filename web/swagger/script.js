...
class ParameterConfig {
    static getEndpointParameters(endpointPath) {
        const endpointConfigs = {
            ...
            '/api/filter': {
                additionalParams: [
                    { name: 'type', example: 'tv', required: false, description: 'Filter by anime type: tv, movie, ova, ona, special (optional)' },
                    { name: 'status', example: 'ongoing', required: false, description: 'Filter by status: ongoing, completed (optional)' },
                    { name: 'rated', example: 'PG', required: false, description: 'Rating of anime (e.g., G, PG, etc.) (optional)' },
                    { name: 'score', example: '2', required: false, description: 'Score rating (e.g., 1 to 10) (optional)' },
                    { name: 'season', example: 'winter', required: false, description: 'Filter by season: winter, spring, summer, fall (optional)' },
                    { name: 'language', example: 'sub', required: false, description: 'Language of anime (e.g., sub, dub) (optional)' },
                    { name: 'genres', example: 'action,adventure', required: false, description: 'Comma-separated list of genres (e.g., action, comedy) (optional)' },
